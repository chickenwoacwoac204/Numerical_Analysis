...
# def secant_method(f, df, ddf, df_expr, a, b, error=1e-6, max_iterations=100, mode=1):
...
#     print("Mode 0: Sai số tuyệt đối theo công thức sai số mục tiêu")
#     print("Mode 1: Sai số tuyệt đối theo công thức 2 xấp xỉ liên tiếp")
#     print("Mode 2: Sai số tương đối theo công thức sai số mục tiêu")
#     print("Mode 3: Sai số tương đối theo công thức 2 xấp xỉ liên tiếp")
    
#     try:
#         mode = 3  # Chọn chế độ đánh giá sai số (0-3)
#         a = -2.0  # Nhập giá trị a (biên dưới của khoảng cách ly nghiệm)
#         b = -1.0  # Nhập giá trị b (biên trên của khoảng cách ly nghiệm)
#         error = 1e-7  # Nhập sai số
        
#         result = secant_method(f, df, ddf, df_expr, a, b, error=error, mode=mode)
